...
public class RisultatiRicercaFrame extends JFrame {
	...
	public RisultatiRicercaFrame(Starter starter,Utente utenteConnesso,String token,List<Inserzione> inserzioni,JFrame frame) {
		...
		btnIndietro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starter.switchRisultatiRicercaToFramePrecedente(frame);
			}
		});
	...
	public void loadInserzioni() {
        ...
        for (Inserzione inserzione: inserzioni) {
            panelInserzioni.add(new InserzioneRicercaPanel(starter,utenteConnesso,token,inserzione));
