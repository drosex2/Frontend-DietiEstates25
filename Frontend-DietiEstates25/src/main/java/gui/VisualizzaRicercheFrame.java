...
import dto.Ricerca;
import panel.RicercaPanel;
import starter.Starter;

public class VisualizzaRicercheFrame extends JFrame {
	...
	public VisualizzaRicercheFrame(Starter pStarter,List<Ricerca> pRicerche,String pToken) {
		...
		JLabel lblNewLabel = new JLabel("Cronologia ricerche");
		...
		btnIndietro.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				starter.switchVisualizzaRicercheToHomePageUtente();
			}
		});
        ...
        for (Ricerca ricerca: ricerche) {
            panelControfferte.add(new RicercaPanel(starter,ricerca,token,frame));
