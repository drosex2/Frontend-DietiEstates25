...
public class SignUpFrame extends JFrame {
	...
	public SignUpFrame(Starter starter) {
		...
		JLabel lblWelcome = new JLabel("Effettua la registrazione");
		...
		RoundedButton btnRegistrati = new RoundedButton("Registrati",30,30);
		...
		btnRegistrati.setEnabled(false);
		btnRegistrati.setFont(new Font("Arial", Font.PLAIN, 18));
		JFrame myFrame=this;
		...
		btnRegistrati.setPreferredSize(new Dimension(150, 30));
		btnRegistrati.setBackground(new Color(255, 175, 68));
		GridBagConstraints gbc_btnRegistrati = new GridBagConstraints();
		gbc_btnRegistrati.anchor = GridBagConstraints.SOUTHEAST;
		gbc_btnRegistrati.insets = new Insets(0, 0, 0, 5);
		gbc_btnRegistrati.gridx = 0;
		gbc_btnRegistrati.gridy = 0;
		panel_1.add(btnRegistrati, gbc_btnRegistrati);
